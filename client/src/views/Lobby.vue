  ...
  <div>
    <nav id="navbar" class="navbar navbar-light">
      <a class="navbar-brand" href="#">
        <img
          src="https://p7.hiclipart.com/preview/404/818/548/5bbc233fcf90b-thumbnail.jpg"
          width="30"
          height="30"
    ...
    <div id="lobby">
      <div id="homeBox">
        ...
        <div id="roomForm">
          <form>
            <label for="room">Bikin ruangan baru ah..</label>
            <br />
            <input type="text" name="room" id="room" placeholder="ruangan baru.." />
            <br />
            <br />
